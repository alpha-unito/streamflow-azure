...
@pytest.mark.asyncio
@patch('azure_streamflow.executor.BatchClient', autospec=True)
@patch('azure_streamflow.executor.DefaultAzureCredential')
async def test_create_pool(mock_credentials, mock_batch_client_class, mock_config):
    ...
    mock_batch_client_instance.pool.add = AsyncMock()
    ...
    mock_batch_client_instance.pool.add.assert_awaited_once()
...
async def test_submit_job(mock_credentials, mock_batch_client_class, mock_config):
    ...
    mock_batch_client_instance.job.add = AsyncMock()
    mock_batch_client_class.return_value = mock_batch_client_instance
    ...
    mock_batch_client_instance.job.add.assert_awaited_once()
...
async def test_submit_task(mock_credentials, mock_batch_client_class, mock_config):
    ...
    mock_batch_client_instance.task.add = AsyncMock()
    mock_batch_client_class.return_value = mock_batch_client_instance
    ...
    mock_batch_client_instance.task.add.assert_awaited_once()
...
async def test_monitor_job(mock_credentials, mock_batch_client_class, mock_config):
    ...
    mock_batch_client_instance.job = MagicMock()
    mock_batch_client_instance.job.get = AsyncMock(return_value=mock_job)  # ✅ fix qui
    mock_batch_client_class.return_value = mock_batch_client_instance
    ...
    mock_batch_client_instance.job.get.assert_awaited_once_with("testjob")
...
async def test_delete_pool(mock_credentials, mock_batch_client_class, mock_config):
    ...
    mock_batch_client_instance = MagicMock()
    mock_batch_client_instance.pool = MagicMock()
    mock_batch_client_instance.pool.delete = AsyncMock()
    mock_batch_client_class.return_value = mock_batch_client_instance
    ...
    mock_batch_client_instance.pool.delete.assert_awaited_once_with("testpool")